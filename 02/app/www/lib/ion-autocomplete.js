    ...
    function ($ionicTemplateLoader, $ionicBackdrop, $rootScope, $document, $q, $parse, $ionicPlatform) {
        return {
            ...
            link: function (scope, element, attrs, ngModel) {
                ...
                scope.placeholder = !scope.placeholder ? 'Vyplnit položku' : scope.placeholder;
                // set the default values of the passed in attributes
                scope.cancelLabel = !scope.cancelLabel ? scope.multipleSelect === "true" ? 'Hotovo' : 'Zrušit' : scope.cancelLabel;
                scope.selectItemsLabel = !scope.selectItemsLabel ? 'Vybrat položku...' : scope.selectItemsLabel;
                scope.selectedItemsLabel = !scope.selectedItemsLabel ? 'Vybrané položky:' : scope.selectedItemsLabel;
                ...
                $ionicTemplateLoader.compile({
                    ...
                    compiledTemplate.scope.selectItem = function (item) {
                        ...
                        compiledTemplate.scope.searchQuery = "aaa";
                    ...
                    compiledTemplate.scope.searchQueryFunction = function (query) {
                    ...
                    compiledTemplate.scope.$watch('searchQuery', function (query) {
                        compiledTemplate.scope.searchQueryFunction(query);
                    });
                    ...
                    var displaySearchContainer = function() {
                        ...
                        compiledTemplate.scope.searchQueryFunction("");
                    ...
                    compiledTemplate.element.find('button').bind('click', function (event) {
                        compiledTemplate.scope.searchQuery = "bbb";
                        hideSearchContainer();
                    });
